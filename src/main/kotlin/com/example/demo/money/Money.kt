...
import com.example.demo.money.exception.CurrencyMismatchException
...
class Money(
  ...
  init {
    ...
    if (currency.scale == 0 && amount.scale() > 0) {
      ...
      require(decimalPart.compareTo(BigDecimal.ZERO) == 0) { throw IllegalArgumentException("Amount scale is too large") }
    }
  }
